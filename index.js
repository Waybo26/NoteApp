let notes = [
    {
        id: new Date(),
        title: "Sample Note",
        body: "This is a description for out sample note",
        bgColor: "orange"
    }
]
...
document.querySelector('button.add').onclick = () => saveNotes();
